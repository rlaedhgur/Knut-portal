...
// ✅ 2025-2학기를 3열 맨 위로 강제 이동 (표시만)
const moveTarget = sorted.find((s) => s.year === 2025 && s.term.startsWith("2"));
const displayTerms = moveTarget ? sorted.filter((s) => s !== moveTarget) : sorted;

const [col1, col2, col3] = splitTo3Cols(displayTerms);

if (moveTarget) col3.unshift(moveTarget);
